"""Smoke tests for Common-test-MCP.
...
def test_package_importable():
    import common_test_mcp  # noqa: F401
    import common_test_mcp.server  # noqa: F401


def test_server_instantiable():
    from common_test_mcp.server import app

    assert app is not None
    assert app.name == "Common-test-MCP"


def test_list_tools_returns_advertised_surface():
    from common_test_mcp.server import list_tools
...
def test_visual_challenge_tools_registered():
    ...
    from common_test_mcp.server import list_tools, _dispatch
...
def test_consent_gate_blocks_without_env(monkeypatch):
    ...
    import common_test_mcp.config as cfg
    importlib.reload(cfg)

    from common_test_mcp.tools import visual_challenge as vc
    importlib.reload(vc)
...
def test_schemathesis_runner_registered():
    ...
    from common_test_mcp.runners import REGISTRY
...
def test_qa_lang_switches_builtin_methodology():
    ...
    from common_test_mcp.tools.qa_context import _builtin_for_lang
...
def test_visual_challenge_fingerprint_table_includes_hcaptcha():
    ...
    from common_test_mcp.tools.visual_challenge import _FINGERPRINTS
