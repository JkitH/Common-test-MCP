# Common-test-MCP v0.7.1 — hCaptcha Support (mini-PRD)

**Status:** Draft v0.1 · **Author:** JkitH (JkitH) · **Last updated:** 2026-05-23 · **Target ship:** v0.7.1 within 1 week of go-decision
...
*End of mini-PRD v0.1 for Common-test-MCP v0.7.1. Cross-reference: `docs/prd-v0.7-visual-challenge.md`.*
