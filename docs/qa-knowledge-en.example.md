...
> |---|---|---|
> | **Built-in methodology** (ISTQB / boundary values / test pyramid / regression / mobile / metrics / API testing / flakiness taxonomy / test doubles / test data) | The "**how to test**" industry-standard concepts | Bundled with Common-test-MCP; `get_qa_context` returns it automatically |
