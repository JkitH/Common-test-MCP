...
`JkitH/Common-test-MCP`. The `smithery.yaml` at repo root handles
...
```
Common-test-MCP (Common-test-MCP)
```
...
```markdown
**Common-test-MCP** turns your AI client (Claude Desktop, Claude Code, Cursor,
...
[README](https://github.com/JkitH/Common-test-MCP#integrations).
...
- Repository: https://github.com/JkitH/Common-test-MCP
- Homepage:   https://github.com/JkitH/Common-test-MCP
- README:     https://github.com/JkitH/Common-test-MCP#readme
- PyPI:       https://pypi.org/project/Common-test-MCP/
...
```
🚀 Common-test-MCP is now on Smithery — one-click install for Claude Desktop,
...
→ smithery.ai/server/JkitH/Common-test-MCP
→ github.com/JkitH/Common-test-MCP
```
