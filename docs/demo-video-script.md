# Demo Video Script — Common-test-MCP
...
| 0:58–1:00 | 結尾卡：`smithery.ai/server/JkitH/Common-test-MCP` + GitHub URL | 無旁白 |
...
GitHub: github.com/JkitH/Common-test-MCP
Smithery: smithery.ai/server/JkitH/Common-test-MCP
```
...
- 字卡：「**Common-test-MCP — 一個 MCP，五個 runner，從 analyze 到 coach。**」
...
- 顯示三個 CTA：
  ...
  - `pip install Common-test-MCP` / `uvx Common-test-MCP`
