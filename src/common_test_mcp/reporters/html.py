...
<title>Test Report — Common-test-MCP</title>
<style>
  :root {
    --bg: #0D1117;
    --bg-elevated: #161B22;
...
<div class="wrap">
  ...
  <header class="header">
    ...
    <h1><span class="breadcrumb">Common-test-MCP /</span> Test Report</h1>
    <div class="meta">
  ...
  <footer>
    Generated by <strong style="color: var(--text);">Common-test-MCP</strong> ·
    <a href="https://github.com/JkitH/Common-test-MCP">github.com/JkitH/Common-test-MCP</a>
  </footer>
