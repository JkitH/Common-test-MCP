...
shipped with Common-test-MCP so you can dogfood the native API runners
...
# Point Common-test-MCP at the bundled collection. Plain filesystem path,
...
The runner generates one Common-test-MCP "test" per `pm.test(...)`
